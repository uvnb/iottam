...
export default function Login() {
  ...
  return (
    <div className="app-container" style={{ justifyContent: 'center', minHeight: '100vh', padding: '2rem' }}>
      ...
      {/* CỘT PHẢI: LOGIN FORM (Bây giờ nằm chính giữa) */}
      <div className="posture-card normal" style={{ width: '100%', maxWidth: '450px', margin: '0 auto', padding: '3rem 2.5rem', background: 'rgba(3, 10, 22, 0.95)', border: '1px solid rgba(0, 210, 255, 0.3)', boxShadow: '0 0 30px rgba(0, 210, 255, 0.1)', borderRadius: '24px' }}>
        ...
        <p style={{ marginTop: '1rem', fontSize: '0.85rem' }}>
          <span 
            onClick={() => navigate('/')} 
            style={{ color: 'var(--text-muted)', cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: '5px' }}
          >
            ← Back to Home
          </span>
        </p>
